...
def findColor(color_thre, img_rgb, img_hsv, y, x):
    ...
    #dh, uh, ds, us, dv, uv
    colorTable = [[75, 105, 180, 255, 180, 255],    #white      0
                  [0, 10, 120, 255, 80, 255],       #red        1
                  [160, 179, 120, 255, 80, 255],    #red        2
                  [10, 25, 63, 255, 80, 255],       #orange     3
                  [25, 40, 43, 255, 80, 255],       #yellow     4
                  [40, 75, 63, 255, 80, 255],       #green      5
                  [75, 110, 40, 255, 80, 255],      #brightBlue 6
                  [110, 130, 40, 255, 80, 255],     #darkBlue   7 
                  [130, 143, 63, 255, 80, 255],     #purple     8
                  [143, 160, 63, 255, 80, 255],     #pink       9
                  [0, 180, 0, 255, 1, 80]]          #black      10
